...
// classe Lista
template< class T >
class List_vector : public Linear_list<T, int>{ // List_vector eridita Linear_list con parametri T,int
 public:
	...
	// operatori
	void create(); //inizializza l'array dinamico
	bool empty() const; 
...
// costruttore di default, imposta la dimensione dell'array a 10 se non specificata
template< class T >

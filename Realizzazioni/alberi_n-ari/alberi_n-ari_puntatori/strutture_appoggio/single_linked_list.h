...
//prima di definire la lista specifichiamo il tipo Nodo
template< class T >
class Node {

 friend class Linked_List<T>; //permette alla classe di accedere alla parte privata di lista
...
template< class T >
class Linked_List : public Linear_list<T, Node<T>*>{   //Linked_List eredita la classe astratta specificando il tipo di valore Template e il tipo posizione con la classe Nodo
 public:
 ...
 private:
	Node<T> * _pHead; //purntatore al primo elemento della lista (testa)
	int _length; // lunghezza della lista
};


//costruttore: alloca la memoria per uin nuovo nodo, imposta la testa la nodo creato, e setta la lunghezza a 0
template< class T >
...
//scrive l'elemento in posizione data
template< class T >
